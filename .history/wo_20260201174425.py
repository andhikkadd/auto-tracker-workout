...
def update_active_counter(features):
    if STATE["active"] == "Bicep Curl":
        ...
        _, L['L']["stage"], L['L']["reps"], L['L']["down_ref"], L['L']["up_ref"], L['L']["down_hold"], L['L']["up_hold"] = process_arm(
            ...
            L["L"]["stage"], L["L"]["reps"],
            L["L"]["down_ref"], L["L"]["up_ref"],
            L["L"]["down_hold"], L["L"]["up_hold"],
            STATE["cfg"]["hold_n"], STATE["alpha"], STATE["L"]["MARGIN"], STATE["v"]
        )
        _, R['R']["stage"], R['R']["reps"], R['R']["down_ref"], R['R']["up_ref"], R['R']["down_hold"], R['R']["up_hold"] = process_arm(
            features["ang_L"], features["l_shoulder"], features["l_elbow"], features["l_wrist"],
            R["R"]["stage"], R["R"]["reps"],
            R["R"]["down_ref"], R["R"]["up_ref"],
            R["R"]["down_hold"], R["R"]["up_hold"],
            STATE["cfg"]["hold_n"], STATE["alpha"], STATE["R"]["MARGIN"], STATE["v"]
        )
