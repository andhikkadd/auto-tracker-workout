...
def update_active_counter(features):
    if STATE["active"] == "Bicep Curl":
        ...
        _, ["curl"]['L']["stage"], ["curl"]['L']["reps"], ["curl"]['L']["down_ref"], ["curl"]['L']["up_ref"], ["curl"]['L']["down_hold"], ["curl"]['L']["up_hold"] = process_arm(
            features["ang_L"], features["l_shoulder"], features["l_elbow"], features["l_wrist"],
            ["curl"]["L"]["stage"], ["curl"]["L"]["reps"],
            ["curl"]["L"]["down_ref"], ["curl"]["L"]["up_ref"],
            ["curl"]["L"]["down_hold"], ["curl"]["L"]["up_hold"],
            STATE["curl"]["cfg"]["hold_n"], STATE["alpha"], STATE["curl"]["L"]["MARGIN"], STATE["v"]
        )
