...
def process_curl(features):
    ...
    def step_side(side_key, ang, shoulder, elbow, wrist):
        ...
        # UPDATE HOLDS UTK STABOLISASI REF DOWN 
        # update holds utk stabilisasi referensi (down_ref / up_ref) ---
        ...
        # --- 2) update refs kalau stabil beberapa frame ---
        ...
        # --- 3) ambang (fallback kalau ref belum kebentuk) ---
        a_high = 150  # posisi lengan lurus (down)
        a_low  = 50   # posisi curl atas (up)
        ...
        # --- 4) klasifikasi posisi (down/mid/up) ---
        label = "NOT_CURL"
