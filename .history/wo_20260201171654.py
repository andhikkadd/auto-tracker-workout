...
def process_pull_up(features,):
    ...
    # === detect bottom ===
    if ["bottom_ref"] is None or delta > ["bottom_ref"] - MARGIN:
        ["bottom_hold"] += 1
    else:
        ["bottom_hold"] = 0
    ...
    if ["bottom_hold"] >= HOLD:
        ["bottom_ref"] = (
            delta if ["bottom_ref"] is None
            else ["bottom_ref"] * (1 - ALPHA) + delta * ALPHA
        )
        ["stage"] = "down"

    # === detect top ===
    if ["top_ref"] is None or delta < ["top_ref"] + MARGIN:
        ["top_hold"] += 1
    else:
        ["top_hold"] = 0
    ...
    if ["top_hold"] >= HOLD:
        ["top_ref"] = (
            delta if ["top_ref"] is None
            else ["top_ref"] * (1 - ALPHA) + delta * ALPHA
        )
